...
**HEAD:** `bbc9827` on `main` locally (sessions 22+23+24); session 25 commit pending (touches `src/serving/backends/clickhouse_backend.py`, `tests/unit/test_clickhouse_backend.py`, `CHANGELOG.md`, `docs/SESSION_HANDOFF.md`)
