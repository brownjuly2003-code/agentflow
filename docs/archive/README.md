...
| [`performance/`](performance/README.md) | Non-canonical mixed-load benchmark reports moved from the `docs/` root | [`perf/load-benchmark-latest.md`](../perf/load-benchmark-latest.md) and [`perf/entity-benchmark-contract.md`](../perf/entity-benchmark-contract.md) |
