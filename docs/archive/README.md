...
| [`performance/`](performance/README.md) | Historical generated benchmarks, non-canonical reports, and superseded performance follow-ups | [Full-load](../perf/load-benchmark-latest.md) and [demo freshness](../perf/freshness-benchmark.md) lifecycles plus [`perf/entity-benchmark-contract.md`](../perf/entity-benchmark-contract.md) |
