...
| [`performance/`](performance/README.md) | Historical generated benchmarks, non-canonical reports, and superseded performance follow-ups | [Full-load](../perf/load-benchmark-latest.md), [demo freshness](../perf/freshness-benchmark.md), and [real-path throughput](../perf/throughput-realpath.md) lifecycles plus [`perf/entity-benchmark-contract.md`](../perf/entity-benchmark-contract.md) |
