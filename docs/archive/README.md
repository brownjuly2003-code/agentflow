...
| [`performance/`](performance/README.md) | Historical generated benchmarks, non-canonical reports, and superseded performance follow-ups | [Full-load benchmark lifecycle](../perf/load-benchmark-latest.md) and [`perf/entity-benchmark-contract.md`](../perf/entity-benchmark-contract.md) |
