...
> **Archive metadata**
>
> - Original path: *docs/perf/freshness-benchmark.md*
> - Archived: 2026-08-29
> - Reason: this host- and time-dependent report was a mutable tracked output
>   whose renderer no longer reproduced its later S7/S8 historical note
> - Current replacement: [demo freshness benchmark artifact lifecycle](../../perf/freshness-benchmark.md);
>   new reports are written by
>   [`scripts/benchmark_freshness.py`](../../../scripts/benchmark_freshness.py)
>   under ignored `.artifacts/freshness/`
> - Content type: historical generated demo freshness benchmark snapshot
>
...
> [`freshness-e2e-realpath.md`](freshness-e2e-realpath.md).
