...
> **Archive metadata**
>
> - Original path: *docs/perf/throughput-realpath.md*
> - Archived: 2026-08-29
> - Reason: this host- and time-dependent S10 report was a mutable tracked
>   output of the real-path throughput harness
> - Current replacement: [real-path throughput benchmark artifact lifecycle](../../perf/throughput-realpath.md);
>   new reports are written by
>   [`scripts/benchmark_throughput_realpath.py`](../../../scripts/benchmark_throughput_realpath.py)
>   under ignored `.artifacts/throughput/`
> - Content type: historical generated S10 throughput baseline snapshot
>
