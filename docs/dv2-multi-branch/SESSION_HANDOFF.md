...
- ✅ **CronJob fanout** (session 3): `infrastructure/dv2/cold-offload-fanout.yaml` — 4 CronJob клона для spb/ekb/dxb/ala с staggered schedules (msk 02:00, spb 02:30, ekb 03:00, dxb 04:00, ala 05:00) на общем RWO PVC `cold-exports`. Manual SPB job отработал за ~8с (image cached), parquet 13 366 B / 500 rows.
