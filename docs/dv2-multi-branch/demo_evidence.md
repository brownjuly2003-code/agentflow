...
> explicitly. §14/15 (MaterializedPostgreSQL CDC) were genuinely attempted but
> did not complete — see their own section for the honest account of why
> (host resource contention, not a config bug). The standalone WSL-CH /
