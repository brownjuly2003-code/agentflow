...
**Updated:** 2026-09-03 (production Ingress rules cannot route /metrics)
...
Evidence: `src/agentflow_runtime/serving/api/main.py`, `src/agentflow_runtime/serving/api/auth/middleware.py`, `helm/agentflow/templates/production-contract.yaml`, `helm/agentflow/templates/ingress.yaml`, `helm/agentflow/templates/networkpolicy.yaml`, `tests/unit/test_metrics_not_publicly_routed.py`, `tests/unit/test_docs_profile_gate.py`
