...
**Updated:** 2026-09-04 (production Ingress rules cannot route /metrics; NetworkPolicy must enumerate the scrape namespace; production Service type is ClusterIP)
