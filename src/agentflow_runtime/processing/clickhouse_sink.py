...
class ClickHouseSink:
    ...
    def __init__(self, backend: ClickHouseBackend) -> None:
        ...
        # `python -m agentflow_runtime.serving.provision --schema --seed`, which the demo
    ...
    def existing_event_identities(
        ...
        node-ingest guard (``src/agentflow_runtime/serving/node/ingest.py``), with tenant scope
