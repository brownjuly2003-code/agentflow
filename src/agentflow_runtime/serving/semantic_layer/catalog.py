...
from agentflow_runtime.serving.semantic_layer.entity_type_registry import load_entity_contracts
...
class MetricDefinition:
    ...
    # src/agentflow_runtime/processing/local_pipeline._process_event (orders_v2 <- order.*,
