...
from agentflow_runtime.serving.backends import ServingBackend, create_backend
...
class QueryEngine(
    ...
    def __init__(
        ...
        *,
        ...
        # agentflow_runtime.serving.provision`, or the bridge writer — and /health/ready says
