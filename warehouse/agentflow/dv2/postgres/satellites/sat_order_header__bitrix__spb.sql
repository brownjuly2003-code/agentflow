...
*/
CREATE TABLE IF NOT EXISTS rv.sat_order_header__bitrix__spb (
    order_hk BYTEA NOT NULL,
    load_ts       TIMESTAMP(3) NOT NULL DEFAULT now(),
    hash_diff     BYTEA NOT NULL,
    record_source TEXT NOT NULL DEFAULT 'bitrix__spb',
