...
*/
CREATE TABLE IF NOT EXISTS rv.sat_customer_personal__1c__dxb (
    customer_hk FixedString(16),
    load_ts       DateTime64(3) DEFAULT now64(3),
    hash_diff     FixedString(16),
    record_source LowCardinality(String) DEFAULT '1c__dxb',
    first_name    String,
    last_name     String,
    email         String,
    phone         String,
